...
export const NavigationBar = () => {
  ...
  return (
    <nav className="fixed top-2 left-3 right-3 sm:top-3 sm:left-4 sm:right-4 z-50">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center px-4 sm:px-6 py-2.5 sm:py-3 bg-[var(--surface-glass)] backdrop-blur-xl border border-border rounded-2xl shadow-[var(--shadow-card)] relative">
          {/* Bottom glow line */}
